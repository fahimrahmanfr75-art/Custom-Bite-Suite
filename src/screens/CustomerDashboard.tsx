...
export function CustomerDashboard() {
  ...
  // Calculate total price including mandatory ingredients
  function calculateDishPriceWithMandatory(dish: Dish | null | undefined): number {
    if (!dish) return 0;
    const mandatoryExtraCost = (dish.ingredients || [])
      .filter(ing => ing.isMandatory && ing.extraPrice > 0)
      .reduce((sum, ing) => sum + ing.extraPrice, 0);
